...
const LivestreamEditPage: React.FC = () => {
  ...
  const [modalUpdateFlatformVisible, setModalUpdateFlatformVisible] = useState(false);
  ...
  async function fetchLiveStreamDetail(_liveId: string) {
    try {
      ...
      const { _id, fullLinkTwitter, fullLinkYoutube, fullLinkTelegram, topics, end_stream_code, commentFilterTime } =
        detailResponse;
      ...
      <EditTemplate hideButton>
        <FormProvider {...formMethods}>
          <EditTemplate.Form onSubmit={formMethods.handleSubmit(onSubmitForm)}>
            <Row>
              <Col span={24}>
                <AnswerLibraryField fieldName="answerSubject" allowAdd={false} />
              </Col>
            </Row>
            <Row gutter={24}>
              <Col span={24} lg={24}>
                <TextField readOnly label="End Stream Code" name="end_stream_code" />
              </Col>
              <Col span={24} lg={24}>
                <TextField
                  readOnly
              ...
              <Col span={24} lg={24}>
                <TextField label="Link youtube" name="youtubeLink" placeholder="Nhập link youtube" readOnly />
              </Col>
              <Col span={24} lg={24}>
                <TextField label="Link twitter" name="twitterLink" placeholder="Nhập link twitter" readOnly />
              </Col>
              <Col span={24} lg={24}>
                <TextField label="Link telegram" name="telegramLink" placeholder="Nhập link telegram" readOnly />
              </Col>
            </Row>
          </EditTemplate.Form>
        </FormProvider>
