...
const getThemeVariables = (theme: ThemeType) => css`
  ...
  --primary-rgb-color: ${themeObject[theme].primary};
  --info-rgb-color: ${themeObject[theme].primary};
  --secondary-rgb-color: ${themeObject[theme].secondary};
  --error-rgb-color: ${themeObject[theme].error};
  --warning-rgb-color: ${themeObject[theme].warning};
  --success-rgb-color: ${themeObject[theme].success};
  --background-rgb-color: ${themeObject[theme].background};
  ...
  --chart-rgb-color1: ${themeObject[theme].chartTooltipLabel};
  ...
  --chart-rgb-color5: ${themeObject[theme].chartTooltipLabel};
  ...
  --pagination-active-color: ${themeObject[theme].paginationActiveBg};
  --text-invert: ${themeObject[theme].textInvert};
  --text-base: ${themeObject[theme].textBase};
`;
